...
const logger = new logger_config_1.Logger('WebsocketRouter');
    ...
    constructor(...guards) {
        ...
        this.router
            ...
            const response = yield this.dataValidate({
                request: req,
                schema: validate_schema_1.websocketSchema,
                ClassRef: websocket_dto_1.WebsocketDto,
                execute: (instance, data) => whatsapp_module_1.websocketController.createWebsocket(instance, data),
            });
            ...
            const response = yield this.dataValidate({
                ...
                execute: (instance) => whatsapp_module_1.websocketController.findWebsocket(instance),
            });
