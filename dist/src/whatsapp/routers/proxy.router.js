...
const proxy_dto_1 = require("../dto/proxy.dto");
const whatsapp_module_1 = require("../whatsapp.module");
const index_router_1 = require("./index.router");
const logger = new logger_config_1.Logger('ProxyRouter');
    ...
    constructor(...guards) {
        ...
        this.router
            ...
            const response = yield this.dataValidate({
                ...
                execute: (instance, data) => whatsapp_module_1.proxyController.createProxy(instance, data),
            });
            ...
            const response = yield this.dataValidate({
                ...
                execute: (instance) => whatsapp_module_1.proxyController.findProxy(instance),
            });
