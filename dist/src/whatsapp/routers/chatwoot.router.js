...
const chatwoot_dto_1 = require("../dto/chatwoot.dto");
...
const logger = new logger_config_1.Logger('ChatwootRouter');
    ...
    constructor(...guards) {
        ...
        this.router
            ...
            const response = yield this.dataValidate({
                ...
                execute: (instance, data) => whatsapp_module_1.chatwootController.createChatwoot(instance, data),
            });
            ...
            const response = yield this.dataValidate({
                ...
                execute: (instance) => whatsapp_module_1.chatwootController.findChatwoot(instance),
            });
            res.status(index_router_1.HttpStatus.OK).json(response);
        }))
            .post(this.routerPath('webhook'), (req, res) => __awaiter(this, void 0, void 0, function* () {
            logger.verbose('request received in findChatwoot');
            logger.verbose('request body: ');
            logger.verbose(req.body);
            logger.verbose('request query: ');
            ...
            const response = yield this.dataValidate({
                ...
                schema: validate_schema_1.instanceNameSchema,
                ClassRef: instance_dto_1.InstanceDto,
                execute: (instance, data) => whatsapp_module_1.chatwootController.receiveWebhook(instance, data),
            });
            res.status(index_router_1.HttpStatus.OK).json(response);
        }));
    }
